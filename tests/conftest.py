...
@pytest.fixture
def user_a(db):
    return get_user_model().objects.create_user(username="flibble", password="password")


@pytest.fixture
def user_b(db):
    return get_user_model().objects.create_user(
        username="flobble", password="password", email="flobble@example.com"
    )
...
def super_user(db):
    return get_user_model().objects.create_superuser(
        username="flibble", password="password", email="mrflibble@example.com"
    )
